...
const copy = {
  en: {
    ...
    legalName: 'Hazloc Robotics Inc., a Delaware Company',
  ...
  fr: {
    ...
    legalName: 'Hazloc Robotics Inc., une société du Delaware',
  ...
  es: {
    ...
    legalName: 'Hazloc Robotics Inc., una empresa de Delaware',
  ...
  pt: {
    ...
    legalName: 'Hazloc Robotics Inc., uma empresa de Delaware',
