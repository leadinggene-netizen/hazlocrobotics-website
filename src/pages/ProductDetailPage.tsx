...
const copy = {
  ...
  es: {
    categoryLabel: {
      'explosion-proof': 'Robot antiexplosión',
      electric: 'Robot eléctrico',
      software: 'Plataforma de software',
      peripheral: 'Producto periférico',
    },
  ...
  pt: {
    categoryLabel: {
      'explosion-proof': 'Robô à prova de explosão',
      electric: 'Robô elétrico',
      software: 'Plataforma de software',
      peripheral: 'Produto periférico',
    },
