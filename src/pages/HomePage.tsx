...
const copy = {
  ...
  es: {
    ...
    fleetSubtitle: 'Catorce robots — desde cuadrúpedos antiexplosión hasta software de gestión de flota — construidos para la inspección en áreas peligrosas.',
  ...
  pt: {
    ...
    fleetSubtitle: 'Catorze robôs — de quadrúpedes à prova de explosão a software de gestão de frota — construídos para inspeção em áreas classificadas.',
