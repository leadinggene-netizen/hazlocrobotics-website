...
const copy = {
  ...
  fr: {
    ...
    presenceBody: 'Hazlocrobotics LLC gère les ventes, la conformité et le soutien pour l\'Amérique du Nord et l\'Amérique latine depuis Houston, TX, tandis que Qiteng Robotics — notre partenaire de fabrication — conçoit et construit la gamme de robots à Shenzhen, en Chine. Nos équipes de soutien sur le terrain servent les opérateurs au Moyen-Orient, en Asie du Sud-Est et en Amérique du Nord.',
    offices: [
      { city: 'Houston, TX', role: 'Bureau Amérique du Nord et Amérique latine', desc: 'Opérations commerciales, ventes et conformité pour les marchés d\'Amérique du Nord et d\'Amérique latine.' },
      { city: 'Shenzhen, Chine', role: 'Partenaire de fabrication — Qiteng Robotics', desc: 'Ingénierie robotique, développement de produits et contrôle de la qualité de fabrication.' },
