...
const copy = {
  en: {
    ...
    missionBody2: 'Hazlocrobotics LLC is the North & Latin America commercial partner for Sevnce Robotics\' explosion-proof inspection robot line, combining regional sales, compliance, and site-support expertise with Sevnce\'s robotics engineering and manufacturing capability. Our robots are deployed in 40+ countries across oil & gas, power generation, marine, mining, and emergency response.',
    stats: [
  ...
  pt: {
    ...
    presenceBody: 'A Hazlocrobotics LLC gerencia vendas, conformidade e suporte para a América do Norte e América Latina a partir de Dover, Delaware, enquanto a Sevnce Robotics — nossa parceira de fabricação — projeta e constrói a linha de robôs em Chongqing, China. Nossas equipes de suporte em campo atendem operadores no Oriente Médio, Sudeste Asiático e América do Norte.',
    offices: [
