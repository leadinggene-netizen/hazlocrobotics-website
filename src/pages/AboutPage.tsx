...
const copy = {
  ...
  es: {
    ...
    missionBody2: 'Hazlocrobotics LLC es el socio comercial para Norteamérica y Latinoamérica de la línea de robots de inspección antiexplosión de Qiteng Robotics, combinando experiencia regional en ventas, cumplimiento normativo y soporte en sitio con la ingeniería robótica y capacidad de fabricación de Qiteng. Nuestros robots están desplegados en más de 40 países en petróleo y gas, generación de energía, marítimo, minería y respuesta de emergencia.',
    stats: [
    ...
    presenceBody: 'Hazlocrobotics LLC gestiona ventas, cumplimiento normativo y soporte para Norteamérica y Latinoamérica desde Dover, Delaware, mientras que Qiteng Robotics — nuestro socio de fabricación — diseña y construye la línea de robots en Chongqing, China. Nuestros equipos de soporte en terreno atienden a operadores en Medio Oriente, el sudeste asiático y Norteamérica.',
    offices: [
      ...
      { city: 'Chongqing, China', role: 'Socio de fabricación — Qiteng Robotics', desc: 'Ingeniería robótica, desarrollo de productos y control de calidad de fabricación.' },
  ...
  pt: {
    ...
    missionBody2: 'A Hazlocrobotics LLC é a parceira comercial para a América do Norte e América Latina da linha de robôs de inspeção à prova de explosão da Qiteng Robotics, combinando experiência regional em vendas, conformidade e suporte no local com a engenharia robótica e capacidade de fabricação da Qiteng. Nossos robôs são implantados em mais de 40 países nos setores de petróleo e gás, geração de energia, marítimo, mineração e resposta a emergências.',
    stats: [
    ...
    presenceBody: 'A Hazlocrobotics LLC gerencia vendas, conformidade e suporte para a América do Norte e América Latina a partir de Dover, Delaware, enquanto a Qiteng Robotics — nossa parceira de fabricação — projeta e constrói a linha de robôs em Chongqing, China. Nossas equipes de suporte em campo atendem operadores no Oriente Médio, Sudeste Asiático e América do Norte.',
    offices: [
      ...
      { city: 'Chongqing, China', role: 'Parceira de fabricação — Qiteng Robotics', desc: 'Engenharia robótica, desenvolvimento de produtos e controle de qualidade de fabricação.' },
