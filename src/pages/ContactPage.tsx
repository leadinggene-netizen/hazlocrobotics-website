...
const copy = {
  ...
  es: {
    eyebrow: 'Contacto',
    title: 'Solicite una demostración o evaluación de sitio',
    subtitle: 'Cuéntenos sobre su instalación y sus desafíos de inspección. Nuestro equipo le ayudará a identificar el robot adecuado y a elaborar un plan de implementación adaptado a su sitio.',
    industries: ['Petróleo y gas / Petroquímica', 'Generación de energía', 'Marítimo y offshore', 'Minería', 'Respuesta de emergencia', 'Otro / Aún no estoy seguro'],
    thankYouTitle: 'Gracias por contactarnos',
    thankYouBody: 'Hemos recibido su mensaje y nos pondremos en contacto dentro de un día hábil.',
    ...
    message: 'Mensaje *',
    messagePlaceholder: 'Cuéntenos sobre su instalación, sus desafíos de inspección y lo que está buscando.',
    sending: 'Enviando...',
    sendMessage: 'Enviar mensaje',
    errorRequired: 'Por favor complete su nombre, correo electrónico y mensaje.',
    errorSubmit: 'Algo salió mal al enviar el formulario. Por favor intente de nuevo o escríbanos directamente.',
    ...
    steps: [
      ...
      'Un miembro del equipo se pondrá en contacto dentro de un día hábil para programar una llamada.',
      'Hablamos sobre su sitio, recomendamos un robot y planificamos una demostración o evaluación.',
    ],
  },
  pt: {
    eyebrow: 'Contato',
    title: 'Solicite uma demonstração ou avaliação de local',
    subtitle: 'Conte-nos sobre sua instalação e seus desafios de inspeção. Nossa equipe ajudará a identificar o robô certo e a elaborar um plano de implantação adaptado ao seu local.',
    industries: ['Petróleo e gás / Petroquímica', 'Geração de energia', 'Marítimo e offshore', 'Mineração', 'Resposta a emergências', 'Outro / Ainda não sei'],
    thankYouTitle: 'Obrigado por entrar em contato',
    thankYouBody: 'Recebemos sua mensagem e entraremos em contato dentro de um dia útil.',
    ...
    message: 'Mensagem *',
    messagePlaceholder: 'Conte-nos sobre sua instalação, seus desafios de inspeção e o que você está procurando.',
    sending: 'Enviando...',
    sendMessage: 'Enviar mensagem',
    errorRequired: 'Por favor, preencha seu nome, e-mail e mensagem.',
    errorSubmit: 'Algo deu errado ao enviar o formulário. Tente novamente ou envie um e-mail diretamente.',
    ...
    steps: [
      ...
      'Um membro da equipe entrará em contato dentro de um dia útil para agendar uma chamada.',
      'Discutimos seu local, recomendamos um robô e planejamos uma demonstração ou avaliação.',
    ],
  },
};
