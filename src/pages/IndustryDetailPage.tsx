...
const copy = {
  ...
  es: {
    ...
    recommendedBody: (name: string) => `Los robots más adecuados para entornos de ${name.toLowerCase()}, según el terreno, la clasificación de peligro y los requisitos de inspección.`,
    whoEvaluates: 'Quién suele evaluar esto',
    whoEvaluatesBody: 'Las implementaciones de robots de inspección involucran a múltiples partes interesadas. Si usted ocupa uno de estos roles, podemos adaptar la evaluación a sus prioridades.',
    ctaTitle: (name: string) => `Vea cómo los robots se ajustan a su sitio de ${name}`,
    ctaBody: 'Programe una evaluación de sitio. Evaluaremos su instalación y recomendaremos un plan de implementación adaptado a su clasificación de peligro y requisitos de inspección.',
    ctaButton: 'Solicitar una evaluación de sitio',
    seeCaseStudies: 'Ver casos de éxito',
  },
  pt: {
    notFound: 'Setor não encontrado',
    backToIndustries: 'Voltar aos setores',
    challenge: 'O desafio',
    solution: 'A solução',
    keyBenefits: 'Principais benefícios',
    recommendedFor: 'Recomendado para',
    recommendedBody: (name: string) => `Os robôs mais adequados para ambientes de ${name.toLowerCase()}, com base no terreno, na classificação de risco e nos requisitos de inspeção.`,
    whoEvaluates: 'Quem normalmente avalia isso',
    whoEvaluatesBody: 'As implantações de robôs de inspeção envolvem várias partes interessadas. Se você ocupa uma dessas funções, podemos adaptar a avaliação às suas prioridades.',
    ctaTitle: (name: string) => `Veja como os robôs se adaptam ao seu local de ${name}`,
    ctaBody: 'Agende uma avaliação de local. Avaliaremos sua instalação e recomendaremos um plano de implantação adaptado à sua classificação de risco e requisitos de inspeção.',
    ctaButton: 'Solicitar uma avaliação de local',
    seeCaseStudies: 'Ver estudos de caso',
  },
};
